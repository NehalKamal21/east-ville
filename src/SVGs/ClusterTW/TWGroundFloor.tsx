...
const TWGroundFloor: React.FC = () => {
  ...
  return (
    <svg className="fullScreenSvg" preserveAspectRatio='' xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="2880" height="1800" viewBox="0 0 2880 1800">
      ...
      <image x="2352" y="1412" width="102" height="140" className='villa-TW' xlinkHref={img5} onClick={() => handlePanoramaClick('location4')} />
      <image x="2216" y="1239" width="127" height="224" className='villa-TW' xlinkHref={img6} />  
      <image x="2461" y="1231" width="221" height="317" className='villa-TW' xlinkHref={img7} onClick={() => handlePanoramaClick('location2')} />
      <image x="2217" y="734" width="465" height="495" className='villa-TW' xlinkHref={img8} onClick={() => handlePanoramaClick('location1')} />
    </svg>
  );
};
