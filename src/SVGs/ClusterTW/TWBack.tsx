...
const TWBack: React.FC = () => {
    ...
    return (
        <svg preserveAspectRatio='none' className='fullScreenSvg' xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="2000" height="2401" viewBox="0 0 2000 2401">
            ...
            <image id="groundFloor" className='villa-TW' onClick={(event: React.MouseEvent<SVGImageElement, MouseEvent>) => handleClick(event)} x="428" y="1892" width="1071" height="254" xlinkHref={img1} />
            <image id="firstFloor" className='villa-TW' onClick={(event: React.MouseEvent<SVGImageElement, MouseEvent>) => handleClick(event)} x="417" y="1536" width="1081" height="211" xlinkHref={img2} />
            <image id="secondFloor" className='villa-TW' onClick={(event: React.MouseEvent<SVGImageElement, MouseEvent>) => handleClick(event)} x="419" y="1200" width="1078" height="323" xlinkHref={img3} />
        </svg>
    );
};
