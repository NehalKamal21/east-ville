...
const TWSecondFloor: React.FC = () => {
  ...
  return (
    <svg className="fullScreenSvg" preserveAspectRatio='' xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="2880" height="1800" viewBox="0 0 2880 1800">
      ...
      <image x="2180" y="1313" width="126" height="144" xlinkHref={img4} className='villa-TW' onClick={() => handlePanoramaClick('location6')} />
      <image x="2315" y="1316" width="330" height="228" xlinkHref={img5} className='villa-TW' onClick={() => handlePanoramaClick('location5')} />
      <image x="2177" y="959" width="392" height="347" xlinkHref={img6} className='villa-TW' onClick={() => handlePanoramaClick('location4')} />
      <image x="2547" y="721" width="98" height="230" xlinkHref={img7} className='villa-TW' onClick={() => handlePanoramaClick('location2')} />
      <image x="2422" y="723" width="118" height="229" xlinkHref={img8} className='villa-TW' onClick={() => handlePanoramaClick('location3')} />
      <image x="2178" y="725" width="236" height="301" xlinkHref={img9} className='villa-TW' onClick={() => handlePanoramaClick('location1')} />
